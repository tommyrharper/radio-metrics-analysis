...
- Three cohorts under `cohorts/`: `r2d2-citing` (complete), `classic`, `emerging-ml` (both awaiting approval). See `README.md` for the four-`METRICS_TABLE.md` model and `PLAN.md` for staged milestones.
