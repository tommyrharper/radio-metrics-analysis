...
\title{Radio Interferometry Metrics and Parameters}
...
\subsubsection{Normalized Residual}
...
VLA receiver bands, and recommended calibrator cycle times by configuration, from Table~3.1 \cite{nrao-vla-obsguide}:
\begin{center}
\begin{tabular}{ll}
4  & 54--86~MHz \\
P  & 224--480~MHz \\
