...
\begin{itemize}
    ...
    \item $\x{i}$ is the $i^\text{th}$ CLEAN component model of the night sky, initialised at $\x{0}=\boldsymbol 0$
...
\section{Citing and reference example}
For example, prior work can be cited like this \cite{example2026}.
See Section~\ref{sec:data-model} for the data-model.
